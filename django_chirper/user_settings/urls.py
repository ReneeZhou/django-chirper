...
urlpatterns = [
    ...
    path('screenName/', views.settings_screenName, name = 'settings_screenName'),
    path('security_and_account_access/', views.settings_securityAndAccountAccess, name = 'settings_securityAndAccountAccess'),
    path('privacy_and_safety', views.settings_privacyAndSafety, name = 'settings_provacyAndSafety'),
